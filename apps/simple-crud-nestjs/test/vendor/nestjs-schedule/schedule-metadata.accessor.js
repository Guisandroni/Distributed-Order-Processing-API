...
let SchedulerMetadataAccessor = class SchedulerMetadataAccessor {
    ...
    getSchedulerType(target) {
        return this.getMetadata(schedule_constants_js_1.SCHEDULER_TYPE, target);
    }
    getSchedulerName(target) {
        return this.getMetadata(schedule_constants_js_1.SCHEDULER_NAME, target);
    }
    getTimeoutMetadata(target) {
        return this.getMetadata(schedule_constants_js_1.SCHEDULE_TIMEOUT_OPTIONS, target);
    }
    getIntervalMetadata(target) {
        return this.getMetadata(schedule_constants_js_1.SCHEDULE_INTERVAL_OPTIONS, target);
    }
    getCronMetadata(target) {
        return this.getMetadata(schedule_constants_js_1.SCHEDULE_CRON_OPTIONS, target);
    }
